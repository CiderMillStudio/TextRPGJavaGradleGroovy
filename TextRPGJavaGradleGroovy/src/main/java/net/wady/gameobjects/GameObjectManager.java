...
public class GameObjectManager {
    ...
    public void update(long deltaTime) {
        ...
        for (GameObject gameObject : pending) {
            gameObject.start();
            // System.out.println("GAMEOBJECTMANAGER: " + gameObject.name + " spawned at " + gameObject.position.getX() + ", " + gameObject.position.getY());
        }
        ...
        for (GameObject gameObject : gameObjects) {
            ...
            // System.out.println("GAMEOBJECTMANAGER: " + gameObject.name + " updated at " + gameObject.position.getX() + ", " + gameObject.position.getY());
